...
import com.chen.auth.server.EnableAuthServer;
import com.chen.user.annotation.EnableLoginArgResolver;
...
public class AuthorityApplication {
    public static void main(String[] args) throws UnknownHostException{
        ...
        log.info("应用{}启动成功!swagger地址：http://{}:{}/doc.html",new Object[]{appName,hostAddress,port});
    }
}